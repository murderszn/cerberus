...
(function (root) {
  ...
  function standalone(report, css) {
    ...
    return '<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta http-equiv="Content-Security-Policy" content="default-src \'none\'; script-src \'none\'; style-src \'unsafe-inline\'; img-src data:; object-src \'none\'; base-uri \'none\'; form-action \'none\'; frame-ancestors \'none\'"><title>Cerberus report — ' + escape(review.target) + '</title><style>' + (css || '') + '</style></head><body class="review-document"><header class="export-header"><p>CERBERUS LABS / SECURITY EXAMINATION</p><h1>' + escape(review.target) + '</h1><div class="export-score">' + escape(review.score === null ? '—' : review.score) + '<small>/100</small><span>' + escape(review.grade || '—') + '</span></div><p>' + escape(review.scannedAt || 'Scan date not recorded') + '<br>Commit ' + escape(review.sha || 'not recorded') + (review.ref ? ' · ' + escape(review.ref) : '') + '</p></header><main>' + html(review, false) + '</main><footer class="export-footer">Generated from the recorded Cerberus scan. Raw report data is embedded in this file.</footer><script id="cerberus-report-data" type="application/json">' + json + '</script></body></html>';
  }
